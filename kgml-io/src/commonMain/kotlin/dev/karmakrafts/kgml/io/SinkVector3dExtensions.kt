...
/**
 * Writes the given 3D double vector to this sink in component order `x`, `y`, `z`.
 *
 * @param vector The vector to write.
 */
fun Sink.writeVector3d(vector: Vector3d) {
...
/**
 * Writes the given 3D double vector to this sink in little-endian component order `x`, `y`, `z`.
 *
 * @param vector The vector to write.
 */
fun Sink.writeVector3dLe(vector: Vector3d) {
