...
data class Vector3f( // @formatter:off
     ...
     */
    inline infix fun angle(other: Vector3f): Float = toDegrees(angleRad(other))
     ...
     */
    inline fun signedAngle(other: Vector3f, axis: Vector3f): Float = toDegrees(signedAngleRad(other, axis))
