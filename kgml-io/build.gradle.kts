...
publishing {
    setProjectInfo(
        name = "KGML IO",
        description = "kotlinx.io extensions for the Kotlin graphics maths library",
        url = "https://git.karmakrafts.dev/kk/kgml"
    )
}