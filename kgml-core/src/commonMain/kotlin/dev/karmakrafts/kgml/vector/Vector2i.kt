...
data class Vector2i( // @formatter:off
    ...
    companion object : VectorType {
        ...
        /**
         * Creates a [Vector2i] from the given [array].
         *
         * @param array The array to read from.
         * @param offset The offset in the [array].
         * @return The created [Vector2i].
         */
    ...
    /**
     * Creates a [Vector2i] with all components set to [xy].
     *
    ...
    /**
     * Creates a [Vector2i] with all components set to 0.
     */
    constructor() : this(0)
     ...
     */
    infix fun distanceSq(other: Vector2i): Int {
        val dx = other.x - x
        val dy = other.y - y
     ...
     * @return The distance.
     */
    inline infix fun distance(other: Vector2i): Int = sqrt(distanceSq(other).toFloat()).toInt()

    infix fun angleRad(other: Vector2i): Int = atan2((this cross other).toFloat(), (this dot other).toFloat()).toInt()

    inline infix fun angle(other: Vector2i): Int = (angleRad(other) * TO_DEG).toInt()
